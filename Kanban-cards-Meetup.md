...
### Get all Groups (Feature 1, Part 1)
...
### Get all Groups joined or organized by the Current User (Feature 1, Part 1)
...
### Get details of a Group from an id (Feature 1, Part 1)
...
- [ ] Group data returns associated data for `images`, an array of image urls
...
### Create a Group (Feature 1, Part 1)
...
### Delete a Group (Feature 1, Part 1)
...
### Get all Members of a Group based on the Group's id (Feature 1, Part 2)
...
### Request a Membership for a Group based on the Group's id (Feature 1, Part 2)
...
### Change the status of a membership for a group specified by id (Feature 1, Part 2)
...
### Delete membership to a group specified by id (Feature 1, Part 2)
...
### Create a new Venue for a Group specified by its id (Feature 2)
...
### Edit a Venue specified by its id (Feature 2)
...
### Get all Events (Feature 3, Part 1)
...
- [ ] Event data returned includes the `id`, `groupId`, `venueId`, `name`,
  `type`, `startDate`, and `previewImage`
...
### Get all Events of a Group specified by its id (Feature 3, Part 1)
...
### Get details of an Event specified by its id (Feature 3, Part 1)
...
- [ ] Event data returns associated data for `images`, an array of image urls
- [ ] Error response with status 404 is given when an event does not exist with
  the provided `id`


### Create an Event for a Group specified by its id (Feature 3, Part 1)
...
### Edit an Event specified by its id (Feature 3, Part 1)
...
### Delete an Event specified by its id (Feature 3, Part 1)
...
### Get all Attendees of an Event specified by its id (Feature 3, Part 2)
...
### Request to Attend an Event based on the Event's id (Feature 3, Part 2)
...
### Change the status of an attendance for an event specified by id (Feature 3, Part 2)
...
### Delete attendance to an event specified by id (Feature 3, Part 2)
...
### Add an Image to a Group based on the Group's id (Feature 4)
...
### Add an Image to an Event based on the Event's id (Feature 4)
...
### Add Query Filters to Get All Events (Feature 4)
